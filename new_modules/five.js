...
// ----------------------------------------------
// COUNT ONLY BROKEN TRIANGLE BOXES 🔺
// ----------------------------------------------
export function countBrokenTriangles(boxes) {
  return boxes.filter(
