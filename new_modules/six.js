...
// ----------------------------------------------
// COUNT ONLY UNBROKEN TRIANGLE BOXES 🔺
// ----------------------------------------------
export function countUnbrokenTriangles(boxes) {
  return boxes.filter(
