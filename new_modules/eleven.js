...
export function generatePuzzle_color(totalWords = 10) {
  ...
  ctx.font = "14px Arial";
  ctx.fillStyle = "rgba(27, 25, 25, 0.74)";
  ctx.fillText("powerd by AVI", width - 10, height - 10);
  ...
  return {
    totalWords,
    question: `How many colour names match their text colour out of ${parseInt(totalWords)}?`,
    options,
    answer: matchCount,
    image: base64
  };
