...
function getDifficultyMap(per) {
    if (per < 10) {
        return {
            ...
            "Tough":     { rows: 12, COLS: 10, visibleRatio: 0.05 },
            "Too Tough": { rows: 14, COLS: 12, visibleRatio: 0.025 }
        };
    }
    ...
    if (per < 20) {
        return {
            ...
            "Medium":    { rows: 12, COLS: 9,  visibleRatio: 0.08 },
            "Tough":     { rows: 14, COLS: 11, visibleRatio: 0.04 },
            "Too Tough": { rows: 16, COLS: 13, visibleRatio: 0.02 }
        };
    }

    if (per < 50) {
        return {
            "Too Easy":  { rows: 12, COLS: 6,  visibleRatio: 0.60 },
            "Easy":      { rows: 14, COLS: 8,  visibleRatio: 0.15 },
            "Medium":    { rows: 16, COLS: 10, visibleRatio: 0.06 },
            "Tough":     { rows: 18, COLS: 12, visibleRatio: 0.03 },
            "Too Tough": { rows: 20, COLS: 14, visibleRatio: 0.015 }
        };
    }
    ...
    return {
        ...
        "Easy":      { rows: 16, COLS: 10, visibleRatio: 0.12 },
        "Medium":    { rows: 18, COLS: 12, visibleRatio: 0.05 },
        "Tough":     { rows: 20, COLS: 14, visibleRatio: 0.02 },
        "Too Tough": { rows: 22, COLS: 16, visibleRatio: 0.01 }
    };
}
